...
test('Admin Export - VFS UK OMAN (Filter by Branch)', async ({ page }, testInfo) => {
...
test.skip('Admin Export - VFS UK OMAN (Refund Status - Pending)', async ({ page }, testInfo) => {
...
test('Admin Export - VFS UK OMAN (Refund Status - Approve)', async ({ page }, testInfo) => {
...
test('Admin Export - VFS UK OMAN (Refund Status - Reject)', async ({ page }, testInfo) => {
...
test('Admin Export - VFS UK OMAN (Refund Status - All)', async ({ page }, testInfo) => {
...
test('Admin Export - VFS UK OMAN (Date + Search + Filter)', async ({ page }, testInfo) => {
    await selectDateRange(page);
