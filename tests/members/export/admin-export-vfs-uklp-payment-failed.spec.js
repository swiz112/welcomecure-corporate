...
test('Admin Export - VFS UKLP - Payment Failed', async ({ page }) => {
    ...
    // Navigation to Partners -> VFS UKLP -> Payment Failed Page
    ...
    await page.click('button:has-text("Payment failed")');
