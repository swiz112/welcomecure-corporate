...
const vfsUklpAdminLogin = {
    ...
    postLoginUrl: 'https://staging.corporate.welcomecure.com/vfs_uk_lp/support/memberlist', 
...
test.skip('VFS UKLP Export - Member List (Static Date)', async ({ page }, testInfo) => {
